...
class BrandProductData {
  List<Brand>? _brand;
  List<BrandProduct>? _product;

  BrandProductData({List<Brand>? brand, List<BrandProduct>? product}) {
    if (brand != null) {
      this._brand = brand;
    }
    if (product != null) {
  ...
  List<BrandProduct>? get product => _product;
  set product(List<BrandProduct>? product) => _product = product;
  ...
  BrandProductData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['product'] != null) {
      ...
      json['product'].forEach((v) {
        _product!.add(new BrandProduct.fromJson(v));
      });
    }
  }
