class ButtonProductMaster {
  ...
  List<ButtonProductData>? get data => _data;
  set data(List<ButtonProductData>? data) => _data = data;

  ButtonProductMaster.fromJson(Map<String, dynamic> json) {
    _status = json['status'];
    ...
    if (json['data'] != null) {
      _data = <ButtonProductData>[];
      json['data'].forEach((v) {
        _data!.add(new ButtonProductData.fromJson(v));
      });
    }
  }
...
class ButtonProductData {
  ...
  ButtonProductData.fromJson(Map<String, dynamic> json) {
