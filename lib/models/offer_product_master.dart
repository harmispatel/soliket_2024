...
class OfferProductData {
  List<Offer>? _offer;
  List<OfferProduct>? _product;

  OfferProductData({List<Offer>? offer, List<OfferProduct>? product}) {
    if (offer != null) {
      this._offer = offer;
    }
    if (product != null) {
  ...
  List<OfferProduct>? get product => _product;
  set product(List<OfferProduct>? product) => _product = product;
  ...
  OfferProductData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['product'] != null) {
      _product = <OfferProduct>[];
      json['product'].forEach((v) {
        _product!.add(new OfferProduct.fromJson(v));
      });
    }
  }
