class UpdateBillDetailsMaster {
  ...
  int? _statusCode;
  String? _message;
  BillDetailsData? _data;

  UpdateBillDetailsMaster(
      {bool? status, int? statusCode, String? message, BillDetailsData? data}) {
    if (status != null) {
      this._status = status;
    }
    if (statusCode != null) {
  ...
  BillDetailsData? get data => _data;
  set data(BillDetailsData? data) => _data = data;
  ...
  UpdateBillDetailsMaster.fromJson(Map<String, dynamic> json) {
    ...
    _data = json['data'] != null
        ? new BillDetailsData.fromJson(json['data'])
        : null;
  }
