...
class Section2 extends StatelessWidget {
  ...
  const Section2({super.key, required this.section2});
...
class Section3 extends StatelessWidget {
  ...
  const Section3({super.key, required this.section3});
              ...
              children: [
                ...
                Flexible(
                  ...
                  child: Text(
                    ...
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                    style: getAppStyle(fontWeight: FontWeight.w500, height: 1),
...
class Section4 extends StatefulWidget {
  ...
  const Section4({super.key, required this.section4});
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                widget.section4[index].productName,
                                maxLines: 2,
                                overflow: TextOverflow.ellipsis,
                                style: getAppStyle(
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      widget.section4[index].discountPrice
                                          .toString(),
                                      style: getAppStyle(
                                        color: Colors.black54,
                                        fontSize: 12,
...
class Section6 extends StatelessWidget {
  ...
  const Section6({super.key, required this.section6});
...
class Section7 extends StatelessWidget {
  ...
  const Section7({super.key, required this.section7});
...
class Section8 extends StatelessWidget {
  ...
  const Section8({super.key, required this.section8});
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(12),
                  image: DecorationImage(
                      image: NetworkImage(section8[0].image), fit: BoxFit.fill),
                ),
              ),
              kCommonSpaceH10,
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(12),
                  image: DecorationImage(
                      image: NetworkImage(section8[1].image), fit: BoxFit.fill),
                ),
              ),
              kCommonSpaceH10,
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(12),
                  image: DecorationImage(
                      image: NetworkImage(section8[2].image), fit: BoxFit.fill),
                ),
              ),
            ],
          ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Center(
                                  child: Image.network(
                                    widget.section9[0].products[index].image,
                                    fit: BoxFit.contain,
                                    height: 170,
                                  ),
                                ),
