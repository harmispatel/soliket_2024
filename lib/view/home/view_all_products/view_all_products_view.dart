            ...
            child: Container(
              ...
              child: Stack(
                children: [
                            ...
                            if (mViewModel.viewAllProductList[index].stock == 0)
                              Center(
                                child: ColorFiltered(
                                  ...
                                  child: Image.network(
                                    mViewModel
                                            .viewAllProductList[index].image ??
                                        '',
                                    fit: BoxFit.contain,
                                    height: 170,
                                  ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: getAppStyle(
                              fontSize: 14,
                              color:
                                  mViewModel.viewAllProductList[index].stock ==
                                          0
                                      ? Colors.grey[400]
                                      : Colors.black54,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (mViewModel.viewAllProductList[index].stock !=
                                  0) ...[
                                itemCount > 0
                                    ? Container(
                  ...
                  if (mViewModel.viewAllProductList[index].discountPer != 0 &&
                  ...
                  if (mViewModel.viewAllProductList[index].stock == 0)
                    Padding(
                      padding:
                          EdgeInsets.symmetric(horizontal: 18, vertical: 100),
                      child: Container(
                        decoration: BoxDecoration(
